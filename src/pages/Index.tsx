        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-1 max-w-xl mx-8 flex items-center gap-4">
              ...
              {/* Filters Button */}
              <button className="border border-border rounded-md px-6 py-1.5 flex items-center gap-3 shadow-sm whitespace-nowrap bg-background/50 backdrop-blur-sm hover:bg-background/70">
